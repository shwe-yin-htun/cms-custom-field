...
class CustomFieldController extends Controller
{
     ...
     public function get_acf_group($id)
     {
         ...
         if (isset($_GET['post_id']))
         {
          ...
          $view = view('custom-field.acf_group_value',['acf_group'=>$acf_group,'acf_values'=>$acf_values]);
          return $view;
     }

     public function get_cf_detail_type($id)
     {
           $view = view('custom-field.add_acf_detail',['id'=>$id]);
           return $view;
     }
     ...
     public function g_update(Request $request,$id)
     {
            ...
            echo "<script>
                        ...
                        window.location.href='http://localhost/cms-fixes/public/custom_field';
                  </script>";
     }
